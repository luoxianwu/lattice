...
module HW (led_o, rstn_i, rxd_i, txd_o);
    ...
    wire pll0_inst_clkop_o_net, cpu0_inst_system_resetn_o_net, ahbl0_inst_AHBL_M01_interconnect_HREADYOUT, 
        ahbl0_inst_AHBL_M01_interconnect_HRESP, ahbl0_inst_AHBL_M01_interconnect_HSELx, 
        ahbl0_inst_AHBL_M01_interconnect_HMASTLOCK, ahbl0_inst_AHBL_M01_interconnect_HWRITE, 
        ahbl0_inst_AHBL_M01_interconnect_HREADY, cpu0_inst_AHBL_M1_DATA_interconnect_HMASTLOCK, 
        cpu0_inst_AHBL_M1_DATA_interconnect_HWRITE, cpu0_inst_AHBL_M1_DATA_interconnect_HREADYOUT, 
        cpu0_inst_AHBL_M1_DATA_interconnect_HRESP, ahbl0_inst_AHBL_M00_interconnect_HREADYOUT, 
        ahbl0_inst_AHBL_M00_interconnect_HRESP, ahbl0_inst_AHBL_M00_interconnect_HSELx, 
        ahbl0_inst_AHBL_M00_interconnect_HMASTLOCK, ahbl0_inst_AHBL_M00_interconnect_HWRITE, 
        ahbl0_inst_AHBL_M00_interconnect_HREADY;
    ...
    wire pll0_inst_clkos_o_net, ahbl2apb0_inst_APB_M0_interconnect_PREADY, 
        ahbl2apb0_inst_APB_M0_interconnect_PSLVERR, ahbl2apb0_inst_APB_M0_interconnect_PSELx, 
        ahbl2apb0_inst_APB_M0_interconnect_PWRITE, ahbl2apb0_inst_APB_M0_interconnect_PENABLE;
    ...
    ahbl0 ahbl0_inst (.ahbl_m01_hrdata_mstr_i({ahbl0_inst_AHBL_M01_interconnect_HRDATA}), 
    ...
    ahbl2apb0 ahbl2apb0_inst (.ahbl_haddr_i({ahbl0_inst_AHBL_M01_interconnect_HADDR}), 
            ...
            .apb_pwdata_o({ahbl2apb0_inst_APB_M0_interconnect_PWDATA}), .clk_i(pll0_inst_clkop_o_net), 
            .rst_n_i(cpu0_inst_system_resetn_o_net), .pclk_i(pll0_inst_clkos_o_net), 
            .presetn_i(cpu0_inst_system_resetn_o_net), .ahbl_hsel_i(ahbl0_inst_AHBL_M01_interconnect_HSELx), 
    ...
    apb0 apb0_inst (.apb_m01_prdata_mstr_i({apb0_inst_APB_M01_interconnect_PRDATA}), 
    ...
    cpu0 cpu0_inst (.ahbl_m_instr_haddr_o({cpu0_inst_AHBL_M0_INSTR_interconnect_HADDR}), 
         ...
         .system_resetn_o(cpu0_inst_system_resetn_o_net), .irq1_i(gpio0_inst_INTR_interconnect_IRQ), 
    ...
    gpio0 gpio0_inst (.gpio_io({led_o}), .apb_paddr_i({apb0_inst_APB_M01_interconnect_PADDR[5:0]}), 
          ...
          .apb_penable_i(apb0_inst_APB_M01_interconnect_PENABLE), .apb_psel_i(apb0_inst_APB_M01_interconnect_PSELx), 
          .apb_pwrite_i(apb0_inst_APB_M01_interconnect_PWRITE), .apb_pslverr_o(apb0_inst_APB_M01_interconnect_PSLVERR), 
          .apb_pready_o(apb0_inst_APB_M01_interconnect_PREADY), .int_o(gpio0_inst_INTR_interconnect_IRQ));
    osc0 osc0_inst (.hf_out_en_i(1'b1), .hf_clk_out_o(osc0_inst_hf_clk_out_o_net));
    pll0 pll0_inst (.clki_i(osc0_inst_hf_clk_out_o_net), .rstn_i(rstn_i), 
         .clkop_o(pll0_inst_clkop_o_net), .clkos_o(pll0_inst_clkos_o_net), 
         .lock_o(pll0_inst_lock_o_net));
    ...
    uart0 uart0_inst (.apb_paddr_i({apb0_inst_APB_M00_interconnect_PADDR[5:0]}), 
          ...
          .rxd_i(rxd_i), .txd_o(txd_o), .clk_i(pll0_inst_clkos_o_net), 
          .rst_n_i(cpu0_inst_system_resetn_o_net), .int_o(uart0_inst_INT_M0_interconnect_IRQ), 
          .apb_penable_i(apb0_inst_APB_M00_interconnect_PENABLE), .apb_psel_i(apb0_inst_APB_M00_interconnect_PSELx), 
          .apb_pwrite_i(apb0_inst_APB_M00_interconnect_PWRITE), .apb_pready_o(apb0_inst_APB_M00_interconnect_PREADY), 
          .apb_pslverr_o(apb0_inst_APB_M00_interconnect_PSLVERR));
